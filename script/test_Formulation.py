...
mesh_dir = path
urdf_model_path = path + '/urdf/romeo.urdf'
# print "The path of urdf is ", urdf_model_path
vector = se3.StdVec_StdString()
vector.extend(item for item in path)
robot = tsid.RobotWrapper(urdf_model_path, vector, se3.JointModelFreeFlyer(), True)
